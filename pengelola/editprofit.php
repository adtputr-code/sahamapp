...
$hasil = query("SELECT * FROM profit WHERE id_profit = $id_profit")[0];
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form role="form" method="POST">
            ...
            <div class="form-group" hidden>
              <label for="id_profit">ID Profit</label>
              <input value="<?=$hasil['id_profit']?>" name="id_profit" id="id_profit" type="number" class="form-control" placeholder="ID Profit" readonly required>
            </div>
            <div class="form-group">
              <label for="tgl_profit">Tanggal</label>
              <input value="<?=$hasil['tgl_profit']?>" name="tgl_profit" id="tgl_profit" type="date" class="form-control" placeholder="Tanggal" required>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input value="<?=$hasil['total_profit']?>" name="total_profit" id="total_profit" type="text" class="form-control" placeholder="Profit" required>
                </div>
              </div>
            ...
            <button type="submit" name="editprofit" class="btn btn-primary btn-sm">Update</button>
          </form>
        </div>
        ...
        <tbody>
          ...
          <?php foreach($ambil as $row) :?>
            <tr>
              ...
              <a class="text-danger" onclick="return confirm('Apakah anda yakin?')" href="#">HAPUS</a>
            </td>
            </tr>
          <?php $no++; ?>
          <?php endforeach; ?>
